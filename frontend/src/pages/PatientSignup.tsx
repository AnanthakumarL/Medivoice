  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome to MediVoice, ${response.data.user?.fullName || 'User'}!`,
      });
    ...
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-900 via-green-900 to-teal-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-1/4 left-1/4 opacity-5 animate-pulse psu-delay-2s"
          >
            <Activity className="h-20 w-20 text-white transform -rotate-12" />
          </div>
          <div
            className="absolute top-1/2 right-1/2 opacity-5 animate-pulse psu-delay-4s"
          >
            <Brain className="h-16 w-16 text-white transform rotate-45" />
          </div>
          <div
            className="absolute top-3/4 right-1/3 opacity-5 animate-pulse psu-delay-6s"
          >
        ...
        <div className="absolute inset-0 opacity-4">
          <div className="w-full h-full psu-grid-bg"></div>
        </div>

        {/* Subtle Texture Overlay */}
        <div className="absolute inset-0 opacity-3 psu-texture-bg"></div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/4 left-1/4 w-2 h-2 bg-white/20 rounded-full animate-ping psu-delay-0 psu-duration-4s"
        ></div>
        <div
          className="absolute top-3/4 right-1/3 w-1 h-1 bg-white/30 rounded-full animate-ping psu-delay-2s psu-duration-3s"
        ></div>
        <div
          className="absolute bottom-1/3 left-1/2 w-1.5 h-1.5 bg-white/25 rounded-full animate-ping psu-delay-1s psu-duration-5s"
        ></div>
      </div>
      ...
      <div className="relative z-10 flex flex-row justify-center items-center min-h-screen text-white">
        ...
        <div className="max-w-lg w-full flex-1 psu-ml-3cm">
        ...
        <div className="flex-1 flex justify-end psu-mr-3cm">
